...
1. 腾讯云的配置跟着官网走，下载 node demo，复制 server 到项目下

2. 设置最上级目录下的 project.config.json，添加 qcouldRoot 属性为 server/

3. [配置本地调试环境](https://cloud.tencent.com/document/product/619/11442#.E6.9C.AC.E5.9C.B0.E5.A6.82.E4.BD.95.E6.90.AD.E5.BB.BA.E5.BC.80.E5.8F.91.E7.8E.AF.E5.A2.83) 后，就可以不用每次都提交服务端代码部署后再测试了
